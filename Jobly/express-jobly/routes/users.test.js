...
import { commonBeforeAll, commonBeforeEach, commonAfterEach, commonAfterAll, testJobIds, u1Token, u2Token, adminToken } from "./_testCommon";
...
describe("PATCH /users/:username", () => {
  ...
  test("works: can set new password", async function () {
    ...
    const isSuccessful = await authenticate("u1", "new-password");
